...
To create a 'Machbarkeit' database, concept.csv and module_name.csv are required, which are generated by [ontology_to_mdr_db](https://github.com/diz-unimr/ontology_to_mdr_db)
<br />
