...
To create a database concept.csv and module_name.csv are required, which are generated by [mdr_to_db_conversion](https://github.com/diz-unimr/mdr_to_db_conversion)
<br />
