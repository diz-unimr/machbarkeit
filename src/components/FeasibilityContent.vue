...
export default {
	...
	methods: {
		...
		contentChange() {
			if (this.isMachbarkeitContent === true) {
				this.isMachbarkeitContent = false
				this.isMeineAbfragenContent = true
			} else if (this.isMeineAbfragenContent === true) {
				this.isMachbarkeitContent = true
				this.isMeineAbfragenContent = false
			}
		},
	},
}
